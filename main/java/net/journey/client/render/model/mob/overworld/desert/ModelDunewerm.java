...
public class ModelDunewerm extends ModelBase {
    ...
    public ModelDunewerm() {
        ...
        this.tail[2] = new ModelRenderer(this, 0, 44);
        this.tail[2].setRotationPoint(0.0F, 0.0F, 0.0F);
        this.tail[2].addBox(-28.0F, 3.0F, -4.0F, 10, 6, 6, 0.0F);
        this.head = new ModelRenderer(this, 0, 0);
        this.head.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.head.addBox(-6.0F, 0.0F, -6.0F, 12, 12, 12, 0.0F);
        this.tail[1] = new ModelRenderer(this, 0, 24);
        this.tail[1].setRotationPoint(0.0F, 0.0F, 1.0F);
        this.tail[1].addBox(-18.0F, 1.0F, -6.0F, 12, 10, 10, 0.0F);
        this.tail[3] = new ModelRenderer(this, 36, 0);
        this.tail[3].setRotationPoint(0.0F, 0.0F, 0.0F);
        this.tail[3].addBox(-38.0F, 4.5F, -2.5F, 10, 3, 3, 0.0F);
        this.tail[1].addChild(this.tail[2]);
        this.head.addChild(this.tail[1]);
    ...
    public void setRotationAngle(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        EntityLavasnake entitylavasnake = (EntityLavasnake)par7Entity;
        float f6 = par3 - (float)entitylavasnake.ticksExisted;
        ...
        this.tail[1].rotationPointX = -1.5F;
        this.tail[1].rotationPointY = 0.5F;
        this.tail[1].rotationPointZ = 14.0F;
        this.tail[2].rotateAngleY = MathHelper.sin(par3) * (float)Math.PI * 0.1F;
        this.tail[2].rotationPointX = 0.5F;
        this.tail[2].rotationPointY = 0.5F;
