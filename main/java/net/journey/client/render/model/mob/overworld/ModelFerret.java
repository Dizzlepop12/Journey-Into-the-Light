...
public class ModelFerret extends ModelBase {
    ...
    public ModelFerret() {
        ...
        this.body2.setRotationPoint(-2.0F, 17.6F, 4.0F);
        ...
        this.neck.setRotationPoint(-1.5F, 16.6F, 0.0F);
        ...
        this.mussle.setRotationPoint(0.0F, 19.6F, 0.0F);
        this.mussle.addBox(-1.5F, -2.4F, -3.4F, 3, 2, 2, 0.0F);
        this.body1 = new ModelRenderer(this, 20, 18);
        this.body1.setRotationPoint(-2.5F, 17.6F, 2.0F);
        ...
        this.leg4_3.setRotationPoint(-3.5F, 19.0F, 11.0F);
        this.leg4_3.addBox(0.5F, 4.0F, -3.0F, 2, 1, 3, 0.0F);
        this.tail1 = new ModelRenderer(this, 27, 23);
        this.tail1.setRotationPoint(-1.5F, 20.0F, 12.2F);
        ...
        this.tail2.setRotationPoint(-1.0F, 21.4F, 15.2F);
        ...
        this.leg3_3.setRotationPoint(1.0F, 19.0F, 11.0F);
        ...
        this.leg4.setRotationPoint(-2.5F, 19.0F, 10.0F);
        this.leg4.addBox(-0.5F, 0.0F, -1.5F, 1, 3, 4, 0.0F);
        this.whiskers = new ModelRenderer(this, 0, 24);
        this.whiskers.setRotationPoint(0.0F, 19.6F, 0.0F);
        this.whiskers.addBox(-3.0F, -2.8F, -3.0F, 6, 3, 0, 0.0F);
        this.leg4_2 = new ModelRenderer(this, 44, 4);
        this.leg4_2.setRotationPoint(-2.5F, 19.0F, 11.0F);
        this.leg4_2.addBox(0.0F, 0.0F, -1.5F, 1, 5, 2, 0.0F);
